...
public class KafkaUtils {
	...
	public static final String WATCHER_LEFT_LAST_EVENT_GROUP = "WatcherLeftLastEventGroup4";
	public static final String WATCHER_LEFT_LAST_EVENT_TOPIC = "Watcher-Left-Last-Event";
	public static final String GAME_ROOM_CLOSED_WATCHER_LEFT_LAST_EVENT_GROUP = "GameRoomClosedWatcherLeftLastEventGroup2";
	public static final String GAME_ROOM_CLOSED_WATCHER_LEFT_LAST_EVENT_TOPIC = "Game-Room-Closed-Watcher-Left-Last-Event";
	public static final String WATCHER_LEFT_EVENT_GROUP = "WatcherLeftEventGroup3";
	public static final String WATCHER_LEFT_EVENT_TOPIC = "Watcher-Left-Event";
	public static final String OPENBY_LEFT_FIRST_EVENT_GROUP = "OpenbyLeftFirstEventGroup3";
	public static final String OPENBY_LEFT_FIRST_EVENT_TOPIC = "Openby-Left-First-Event";
	public static final String SECOND_LEFT_FIRST_EVENT_GROUP = "SecondLeftFirstEventGroup3";
	public static final String SECOND_LEFT_FIRST_EVENT_TOPIC = "Second-Left-First-Event";
	public static final String SECOND_LEFT_EVENT_GROUP = "SecondLeftEventGroup3";
	public static final String SECOND_LEFT_EVENT_TOPIC = "Second-Left-Event";
	public static final String OPENBY_LEFT_LAST_EVENT_GROUP = "OpenbyLeftLastEventGroup4";
	public static final String OPENBY_LEFT_LAST_EVENT_TOPIC = "Openby-Left-Last-Event";
	public static final String GAME_ROOM_CLOSED_OPENBY_LEFT_LAST_EVENT_GROUP = "GameRoomClosedOpenbyLeftLastEventGroup4";
	public static final String GAME_ROOM_CLOSED_OPENBY_LEFT_LAST_EVENT_TOPIC = "Game-Room-Closed-Openby-Left-Last-Event";
	public static final String SECOND_LEFT_LAST_EVENT_GROUP = "SecondLeftLastEventGroup4";
	public static final String SECOND_LEFT_LAST_EVENT_TOPIC = "Second-Left-Last-Event";
	public static final String GAME_ROOM_CLOSED_SECOND_LEFT_LAST_EVENT_GROUP = "GameRoomSecondLeftLastEventGroup2";
