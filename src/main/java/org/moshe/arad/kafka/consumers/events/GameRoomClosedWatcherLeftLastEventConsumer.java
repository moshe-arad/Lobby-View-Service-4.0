...
@Component
@Scope("prototype")
public class GameRoomClosedWatcherLeftLastEventConsumer extends SimpleEventsConsumer {
	...
	Logger logger = LoggerFactory.getLogger(GameRoomClosedWatcherLeftLastEventConsumer.class);
	
	public GameRoomClosedWatcherLeftLastEventConsumer() {
	}
