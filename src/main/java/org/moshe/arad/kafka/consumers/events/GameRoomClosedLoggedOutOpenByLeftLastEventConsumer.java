...
@Component
@Scope("prototype")
public class GameRoomClosedLoggedOutOpenByLeftLastEventConsumer extends SimpleEventsConsumer {
	...
	Logger logger = LoggerFactory.getLogger(GameRoomClosedLoggedOutOpenByLeftLastEventConsumer.class);
	
	public GameRoomClosedLoggedOutOpenByLeftLastEventConsumer() {
	}
