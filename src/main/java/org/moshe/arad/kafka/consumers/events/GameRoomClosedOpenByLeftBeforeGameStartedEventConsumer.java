...
@Component
@Scope("prototype")
public class GameRoomClosedOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {
	...
	Logger logger = LoggerFactory.getLogger(GameRoomClosedOpenByLeftBeforeGameStartedEventConsumer.class);
	
	public GameRoomClosedOpenByLeftBeforeGameStartedEventConsumer() {
	}
