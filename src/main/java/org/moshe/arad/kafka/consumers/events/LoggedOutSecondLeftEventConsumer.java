...
public class LoggedOutSecondLeftEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String, String> record) {
		...
		try{
			lobbyView.addGameRoom(loggedOutSecondLeftEvent.getGameRoom());
			lobbyView.deleteSecondUser(loggedOutSecondLeftEvent.getSecond());
			
			lobbyViewChanges.getGameRoomsUpdate().add(loggedOutSecondLeftEvent.getGameRoom());
