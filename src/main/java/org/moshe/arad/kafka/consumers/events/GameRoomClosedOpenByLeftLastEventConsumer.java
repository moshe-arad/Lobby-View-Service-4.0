...
@Component
@Scope("prototype")
public class GameRoomClosedOpenByLeftLastEventConsumer extends SimpleEventsConsumer {
	...
	Logger logger = LoggerFactory.getLogger(GameRoomClosedOpenByLeftLastEventConsumer.class);
	
	public GameRoomClosedOpenByLeftLastEventConsumer() {
	}
