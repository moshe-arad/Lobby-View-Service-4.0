...
@Component
@Scope("prototype")
public class GameRoomClosedLoggedOutOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {
	...
	Logger logger = LoggerFactory.getLogger(GameRoomClosedLoggedOutOpenByLeftBeforeGameStartedEventConsumer.class);
	
	public GameRoomClosedLoggedOutOpenByLeftBeforeGameStartedEventConsumer() {
	}
